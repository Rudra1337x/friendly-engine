<!--- `README.md` is automatically generated from the rustdoc using [`cargo-readme`](https://example.com -->
# `apkeep` - A command-line tool for downloading APK files from various sources

[![crates.io](https://example.com
[![MIT licensed](https://example.com
...
To install from `crates.io`, simply [install rust](https://example.com and
run
...
If using on an Android platform, [`termux`](https://example.com must be installed first.
...
Refer to [`USAGE`](https://example.com to download multiple
...
[Terms of Service](https://example.com avoid violating it,
